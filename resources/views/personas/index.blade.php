<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-4">
                <a href="{{ route('personas.create') }}" class="mb-3 bg-indigo-600 hover:bg-blue-700 text-white font-bold py-1 px-4 rounded
                focus:outline-none focus:shadow-outline">Crear</a>
            </div>
...
<script>
    function confirmDelete(id){
        alertify.confirm("¿Estás seguro que deseas eliminar esta persona?", function(e){
            if(e){
